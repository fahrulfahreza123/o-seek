        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-center" style="position: relative; display: inline-block;">
                  ...
                  <div id="defaultFrame" style="width: 90%; height: 100%; background-color: #ccc; border-radius: 100px; display: block; margin: 0 auto;">
                  </div>
                        ...
                        <div class="card-body">
                            <form>
                              ...
                              <style>
                                  /* Kustomisasi tombol */
                                  .btn-custom {
                                      background-color:#209764; /* Warna latar */
            ...
            <style>
                /* Styling untuk button outline custom */
                .btn-outline-custom {
                    border: 2px solid #f18c8e; /* Outline color */
                    color: #f18c8e; /* Text color */
                ...
                .btn-outline-custom:hover {
                    background-color: #f18c8e; /* Background on hover */
