...
<li class="nav-item">
  ...
  <ul class="submenu" id="manajemenDonasiSubmenu">
    ...
    <li><a class="nav-link mt-1" href="{{('ProgramDonasiOprator')}}"><i class="bi bi-file-earmark-plus"></i> Program Donasi</a></li>
  </ul>
</li>
</ul>
  ...
  <main id="main" class="main">
    ...
    <div class="container mb-3 d-flex">
        <h2 class="ms-5"><b>Edit Program Donasi</b></h2>
    </div>
    ...
    <div class="d-flex justify-content-center align-items-center">
        <div class="" style=" border: 4px solid #D6D6D6; border-radius: 40px; padding: 80px 200px;">
          ...
          @endif
              ...
              {{-- <form action="{{ route('update.program.donasi.operator', $program->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
        
                <div class="mb-3">
                    <label for="nama_program_donasi" class="form-label">Nama Program Donasi</label>
                    <input type="text" name="nama_program_donasi" id="nama_program_donasi" class="form-control" value="{{ old('nama_program_donasi', $program->nama_program_donasi) }}" required>
                </div>
        
                <div class="form-group">
                  <label for="batas_waktu">Batas Waktu</label>
                  <input type="date" name="batas_waktu" id="batas_waktu" class="form-control" value="{{ old('batas_waktu', $program->batas_waktu) }}">
              </div>
        
                <div class="mb-3">
                    <label for="target_donasi" class="form-label">Target Donasi</label>
                    <input type="number" name="target_donasi" id="target_donasi" class="form-control" value="{{ old('target_donasi', $program->target_donasi) }}" required>
                </div>
        
                <div class="mb-3">
                    <label for="foto_panti_asuhan" class="form-label">Foto (Opsional)</label>
                    <input type="file" name="foto_panti_asuhan" id="foto_panti_asuhan" class="form-control">
                </div>
                   ...
                   @method('PUT')
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_program_donasi') is-invalid @enderror" 
                              id="nama_program_donasi" name="nama_program_donasi" value="{{ old('nama_program_donasi', $program->nama_program_donasi) }}" style="width: 800px; border: 1px solid black;">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('batas_waktu') is-invalid @enderror" 
                              id="batas_waktu" name="batas_waktu" value="{{ old('batas_waktu', $program->batas_waktu) }}" style="width: 800px; border: 1px solid black;">
                        @error('batas_waktu')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('target_donasi') is-invalid @enderror" 
                              id="target_donasi" name="target_donasi" value="{{ old('target_donasi', $program->target_donasi) }}" style="width: 800px; border: 1px solid black;" >
                        @error('target_donasi')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                      @if ($program->foto_panti_asuhan)
                          ...
                          <img src="{{ asset('photo/' . $program->foto_panti_asuhan) }}" alt="Foto Program Donasi" 
                               style="width: 170px; height: 90px; border-radius: 8px; margin-bottom: 10px;">
                      @else
                          <!-- Jika foto tidak ada -->
