...
<script>
  ...
  <style>
    ...
    background-color: white; /* Warna latar belakang putih untuk baris ganjil */
}
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul class="collapse submenu" id="akunOperatorSubmenu">
        <li>
          <a class="nav-link collapsed mt-2" href="{{('ManajemenAkun')}}" style=" border: 2px solid #000000;">
            <i class="bi bi-person-badge"></i>
            Detail Profile
          </a>
        </li>
        <li>
          <a class="nav-link collapsed mt-1" href="{{('Sandi')}}" style=" border: 2px solid #000000;">
            <i class="bi bi-key"></i>
            Ubah Password
          </a>
        </li>
        ...
        <div class="row">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center" style="height: 40px">
              ...
              <form action="{{ route('program_donasi.operator') }}" method="GET" class="d-inline">
            ...
            <!-- Tambah Program Donasi Button (Kanan) -->
            <div>
              <button class="btn" style="background-color:#209764; color:white"
                            onclick="window.location.href='{{ 'TambahProgramDonasiOperator' }}'">
      ...
      <tbody>
          @forelse ($programDonasi as $index => $program)
              <tr>
                ...
                <td>
                  <!-- Tombol Edit -->
                  <a href="{{ route('edit.program.donasi.operator', $program->id) }}" class="btn-action-edit">
...
.btn-action-delete {
    ...
    font-size: 18px;
    margin-right: 8px; /* Jarak antar ikon */
    cursor: pointer;
    text-decoration: none;
}

.btn-action-edit:hover {
    color: #198754; /* Warna hijau saat hover (edit) */
}

.btn-action-delete:hover {
    color: #dc3545; /* Warna merah saat hover (delete) */
}
              ...
              <div class="modal fade" id="deleteModal{{ $program->id }}" tabindex="-1" aria-labelledby="deleteModalLabel{{ $program->id }}" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="deleteModalLabel{{ $program->id }}">Konfirmasi Hapus</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            Apakah Anda yakin ingin menghapus program donasi <strong>{{ $program->nama_program_donasi }}</strong>?
                        </div>
          ...
          @empty
              <tr>
                  <td colspan="7" class="text-center">Tidak ada program donasi</td>
              </tr>
          @endforelse
      </tbody>
  </table>
  ...
  <div class="modal fade" id="verticalycentered" tabindex="-1" aria-labelledby="modalLabel"
      ...
      <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="modalLabel"><b>Konfirmasi</b></h5>
