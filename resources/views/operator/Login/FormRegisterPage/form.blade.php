    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light" style=" border-bottom: 2px solid rgb(209, 209, 209);">
        <div class="container-fluid" style="background-color: #ececec; border-radius:30px;">
            ...
            <div class="d-inline-flex p-2">
                <a class="navbar-brand"><img src="{{ asset('assets/img/logo.ini.png') }}" height="50"
                        width="110"></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="d-inline-flex p-2">
                    <button class="btn btn-success" type="button"
                        style="width: 100px; background-color: #27A4DD; color: white; border-color: #27A4DD"><b>Berdonasi</b></button>
                    &nbsp;&nbsp;
                    <button class="btn btn-success" type="button"
                        style="width: 100px; background-color: #000000; color: white; border-color: #000000"><b>Login</b></button>
                </div>
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-6">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="nama_panti_asuhan"
                                    name="nama_panti_asuhan" maxlength="255" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <label for="nama_bank" class="col-sm-4 col-form-label" style="font-size: 0.9rem">Nama
                                Bank</label>
                            <div class="col-sm-8">
                                <select class="form-select form-select-sm form-control" name="nama_bank" id="nama_bank"
                                    required aria-label=". form-select example">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="file" class="form-control" id="dokumen_akte_pendirian"
                                    name="dokumen_akte_pendirian" accept=".pdf" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="sk_pengesahan" class="col-sm-4 col-form-label">SK Pengesahan</label>
                            <div class="col-sm-8">
                                <input type="file" class="form-control" id="sk_pengesahan" name="sk_pengesahan"
                                    accept=".pdf" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="row mb-3">
                            <label for="provinsi" class="col-sm-4 col-form-label"
                                style="font-size: 0.9rem">Provinsi</label>
                            <div class="col-sm-8">
                                <select class="form-select form-select-sm" name="provinsi" id="provinsi" required
                        ...
                        <div class="row mb-3">
                            <label for="kota_kabupaten" class="col-sm-4 col-form-label"
                                style="font-size: 0.9rem">Kota/Kabupaten</label>
                            <div class="col-sm-8">
                                <select class="form-select form-select-sm" name="kota_kabupaten" id="kota_kabupaten"
                                    required aria-label=". form-select example">
                        ...
                        <div class="row mb-3">
                            <label for="kecamatan" class="col-sm-4 col-form-label"
                                style="font-size: 0.9rem">Kecamatan</label>
                            <div class="col-sm-8">
                                <select class="form-select form-select-sm" name="kecamatan" id="kecamatan" required
                                    aria-label=". form-select example">
                        ...
                        <div class="row mb-3">
                            <label for="kelurahan" class="col-sm-4 col-form-label"
                                style="font-size: 0.9rem">Kelurahan</label>
                            <div class="col-sm-8">
                        ...
                        <div class="row mb-3">
                            <label for="dokumen_sosial" class="col-sm-4 col-form-label"
                                style="font-size: 0.9rem">Dokumen Lembaga Kesejahteraan Sosial</label>
                            <div class="col-sm-8">
                                <input type="file" class="form-control form-control-sm" id="dokumen_sosial"
                                    name="dokumen_sosial" accept=".pdf" required>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <h5 class="modal-title text-center text-danger fw-bold" id="successModalLabel">PEMBERITAHUAN
                            !!!</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body text-center">
                        <p>Data Panti Asuhanmu Akan Di Validasi Oleh Admin. Untuk Informasi Login Selanjutnya Akan Di
                            Informasikan.</p>
                    </div>
