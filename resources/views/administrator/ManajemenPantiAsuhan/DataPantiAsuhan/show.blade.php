...
<body>
    ...
    <main id="main" class="main">
        <div class="container"
            style=" border-radius: 40px; border: 2px solid black; padding: 40px; border: 4px solid #D6D6D6; ">
            <center>
                ...
                <div class="row">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="text" name="nama_panti_asuhan" class="form-control"
                                    value="{{ $panti_asuhan->nama_panti_asuhan }}" style="width: 600px; border: 1px solid black;" readonly>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="text" name="nama_yayasan" class="form-control"
                                    value="{{ $panti_asuhan->nama_yayasan }}" style="width: 600px; border: 1px solid black;" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="number" name="jumlah_penghuni" class="form-control"
                                    value="{{ $panti_asuhan->jumlah_penghuni }}" style="width: 600px; border: 1px solid black;" readonly>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="text" name="provinsi" class="form-control"
                                    value="{{ $panti_asuhan->provinsi }}" style="width: 600px; border: 1px solid black;"readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="text" name="kota_kabupaten" class="form-control"
                                    value="{{ $panti_asuhan->kota_kabupaten }}" style="width: 600px; border: 1px solid black;" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="text" name="kecamatan" class="form-control"
                                    value="{{ $panti_asuhan->kecamatan }}" style="width: 600px; border: 1px solid black;" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="text" name="kelurahan" class="form-control"
                                    value="{{ $panti_asuhan->kelurahan }}" style="width: 600px; border: 1px solid black;" readonly>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 ">
                                ...
                                <input type="text" name="no_handphone" class="form-control"
                                    value="{{ $panti_asuhan->no_handphone }}" style="width: 600px; border: 1px solid black;" readonly>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="time" name="jam_operasional" class="form-control"
                                    value="{{ $panti_asuhan->jam_operasional }}" style="width: 600px; border: 1px solid black;" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                <textarea class="form-control" name="alamat" id="textarea" style="height: 136px; width: 600px; border: 1px solid black;" readonly>{{ $panti_asuhan->alamat }} </textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="text" name="kode_pos" class="form-control"
                                    value="{{ $panti_asuhan->kode_pos }}" style="width: 600px; border: 1px solid black;" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="text" name="link_maps" class="form-control"
                                    value="{{ $panti_asuhan->link_maps }}" style="width: 600px; border: 1px solid black;" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-8">
                                <label for="koordinate" class="form-label">Koordinat</label>
                                <input type="text" name="koordinat" class="form-control"
                                    value="{{ $panti_asuhan->koordinat }} " style="width: 600px; border: 1px solid black;" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="sejarah" name="deskripsi" class="form-control" rows="4" style="width: 1235px; border: 1px solid black;" readonly>{{ $panti_asuhan->deskripsi }}</textarea>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea id="visi" name="visi" class="form-control" rows="4" style="width: 600px; border: 1px solid black;" readonly>{{ $panti_asuhan->visi }}</textarea>
                            </div>
                            <!-- Misi -->
                            <div class="col-md-6 mb-3">
                                <label for="misi" class="form-label">Misi</label>
                                <textarea id="misi" name="misi" class="form-control" rows="4" style="width: 600px; border: 1px solid black;" readonly>{{ $panti_asuhan->misi }}</textarea>
                            </div>
                        </div>
                    </div>
