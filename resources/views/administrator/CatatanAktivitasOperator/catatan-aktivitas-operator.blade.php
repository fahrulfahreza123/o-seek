...
<head>
    ...
    <title>Catatan Operator · O-SEEK</title>
...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ 'CatatanAktivitasOperator' }}">
    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="row">
                ...
                <div class="container">
                    <h2><b>Catatan Aktivitas Pengelola Panti</b></h2>
                        ...
                        <table class="table table-striped">
                            <thead class="table-header">
                                <tr>
                                    ...
                                    <th scope="col" style="background-color: #D6D6D6; color:rgb(0, 0, 0);">Tanggal Akses</th>
                                    <th scope="col" style="background-color: #D6D6D6; color:rgb(0, 0, 0);">Nama Operator</th>
                                    <th scope="col" style="background-color:  #D6D6D6; color:rgb(0, 0, 0);">Nama Panti Asuhan</th>
                                    <th scope="col" style="background-color: #D6D6D6; color:rgb(0, 0, 0);">Aktivitas</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
